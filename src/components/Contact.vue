    ...
    <div class="inner">
        ...
        <div class="text box-row">
            ...
            <div class="box">
                ...
                <p>mail: ono.kazunori.kw@gmail.com</p>
            </div>
            <div class="box">
                ...
                <p>qiita: <a href="https://qiita.com/matopenKW">https://qiita.com/matopenKW</a></p>
            </div>
        </div>
    </div>
</template>